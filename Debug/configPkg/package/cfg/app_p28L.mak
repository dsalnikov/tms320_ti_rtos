...
package/cfg/app_p28L.s28L: package/cfg/app_p28L.c package/cfg/app_p28L.mak
	...
	$(RM) $@
	@$(MSG) cl28L -n $< ...
	$(ti.targets.C28_large.rootDir)/bin/cl2000 -c -n -s --symdebug:none -g --optimize_with_debug -qq -pdsw225 -Dfar=  -v28 -DLARGE_MODEL=1 -ml -eo.o28L -ea.s28L   -Dxdc_cfg__xheader__='"configPkg/package/cfg/app_p28L.h"'  -Dxdc_target_name__=C28_large -Dxdc_target_types__=ti/targets/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_6_2_7 -O2  $(XDCINCS) -I$(ti.targets.C28_large.rootDir)/include -fs=./package/cfg -fr=./package/cfg -fc $<
